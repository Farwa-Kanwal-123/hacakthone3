...
// // //   const [quantity, setQuantity] = useState(1);
// // //   const [selectedImage, setSelectedImage] = useState(0);
// // //   const [product, setProduct] = useState<ImageData | null>(null);
...
// // //         console.log("Fetched Product:", data); // Debugging: Log fetched data
// // //         setProduct(data);
// // //       } catch (error) {
...
// // //                 <p>Delicious and fresh food item.</p>
// // //                 <div className="flex gap-4 items-center">
// // //                   <div className="flex items-center border rounded-md">
// // //                     <button
// // //                       onClick={() => setQuantity(Math.max(1, quantity - 1))}
...
// // //                     </button>
// // //                   </div>
// // //                   <Button className="flex-1 bg-[#FF9F0D] text-white hover:bg-gray-100 hover:text-[#FF9F0D] font-bold text-lg">
// // //                     Add to Cart
// // //                   </Button>
// // //                 </div>
...
// // //                       priority
// // //                       className="w-full h-full object-cover"
// // //                       placeholder="empty" // Disable blur placeholder
// // //                     />
// // //                   </button>
// // //                 </div>
// // //                 <div className="flex-1 rounded-lg overflow-hidden">
...
// // //         <div className="max-w-5xl mx-4 sm:mx-6 md:mx-8 lg:mx-auto">
// // //           {/* Product Details Section */}
// // //           <div className="bg-white rounded-md shadow-sm p-4 md:p-6 lg:p-8">
// // //             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
// // //               {/* Image Gallery */}
// // //               <div className="flex gap-4">
// // //                 <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <Button
                    className="flex-1 bg-[#FF9F0D] text-white hover:bg-gray-100 hover:text-[#FF9F0D] font-bold text-lg"
